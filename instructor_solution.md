...
class DiceGame:
    ...
    def play(self):
        print("=============================")
        print("í¾² Welcome to Roll the Dice!")
        print("=============================")
        while True:
            self.play_round()
    ...
    def print_welcome(self):
        print("\n------ New Round ------")
        input("í¾² Press any key to roll the dice.í¾² ")
